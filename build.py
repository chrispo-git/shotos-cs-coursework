...
shutil.copytree(r"sprites2", r"dist\main\sprites3")
shutil.copytree(r"reverse_sprites2", r"dist\main\reverse_sprites3")
shutil.copytree(r"sprites2", r"dist\main\sprites4")
shutil.copytree(r"reverse_sprites2", r"dist\main\reverse_sprites4")
